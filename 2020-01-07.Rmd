...
for(i in seq_along(cities)){
  ...
  ggplot(data = subset(climate_mean, climate_mean$city_name == cities[i])) +
    ...
    geom_point(aes(x = month_name,
               ...
               color = "red") +
    # scale wrangling
    scale_y_continuous(limits = c(-2, 35), # keeps scales consistent across plots, >-2 will cut off Canberra ribbon [CHECK OUT COORD_CARTESIAN FOR SOMETHING BETTER (MAYBE)]
